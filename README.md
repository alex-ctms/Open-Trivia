...
```
cd existing_repo
git remote add origin https://gitlab.k8s.myctms.it/ctms/labs/trivia-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.k8s.myctms.it/ctms/labs/trivia-app/-/settings/integrations)
